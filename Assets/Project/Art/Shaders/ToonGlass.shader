Shader "Toon/Lit Glass" 
{
    Properties
    {
        ...
        _MainAlpha("Main Alpha", Range(0, 1)) = 0.4
...
#pragma lighting ToonRamp exclude_path:prepass
        ...
        sampler2D _MainTex;
        float _MainAlpha;
        sampler2D _SpecularTex; // specular color texture
        ...
        void surf(Input IN, inout SurfaceOutput o)
        {
            ...
            fixed4 specularColor = tex2D(_SpecularTex, IN.uv);
            o.Emission += saturate(viewSpecLine + specular) * specularColor * 2;
            
            o.Alpha = saturate(_MainAlpha + (viewSpecLine + specular + outerrim + innerglow));
            fixed4 col = tex2D(_MainTex, IN.uv);
            o.Albedo = saturate(o.Albedo + col);
        }
