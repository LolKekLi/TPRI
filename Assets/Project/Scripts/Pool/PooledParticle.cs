...
namespace Project
{
    public class PooledParticle : PooledBehaviour
    {
        ...
        {
            ParticleSystem.Burst[] bursts = new ParticleSystem.Burst[10];
            ...
            foreach (var particleSystem in _particleSystems)
            {
                ...
                {
                    int burstCount = particleSystem.emission.GetBursts(bursts);
        ...
        private IEnumerator BurstEmitCor(ParticleSystem.Burst burst, Action<int> emitAction)
        {
            ...
            for (int cycleIndex = 0; cycleIndex < burst.cycleCount; cycleIndex++)
            {
